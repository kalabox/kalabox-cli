...
exports.activate = function(app, callback) {
  return core.events.emit('pre-app-activate', app)
  .then(function() {
  ...
  .then(function() {
    return core.events.emit('post-app-activate', app);
  })
  .nodeify(callback);
};

var _create = function(name, config, callback) {

  // Emit pre app create event.
  return core.events.emit('pre-app-init', config)
  // Get provider.
  .then(function() {
  ...
  // Emit post event.
  .tap(function(app) {
    return core.events.emit('post-app-init', app);
  })
...
var create = exports.create = function(name, config, callback) {
  if (_apps[name]) {
    ...
    return _create(name, config, callback)
    .tap(function(app) {
      _apps[name] = app;
    })
    .nodeify(callback);
...
var uninstall = exports.uninstall = function(app, callback) {
  ...
  // Emit pre event.
  .then(function() {
    return app.events.emit('pre-app-uninstall', app);
  })
  // Kill components.
  .then(function() {
  ...
  // Emit post event.
  .then(function() {
    return app.events.emit('post-app-uninstall', app);
  })
  // Return.
  .nodeify(callback);
...
var start = exports.start = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-app-start', app);
  })
  ...
  .then(function() {
    ...
    return app.events.emit('post-app-start', app);
  })
  // Return.
  .nodeify(callback);
...
var stop = exports.stop = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-app-stop', app);
  })
  // Stop components.
  .then(function() {
  ...
  .then(function() {
    ...
    return app.events.emit('post-app-stop', app);
  })
  // Return.
  .nodeify(callback);
...
exports.destroy = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-app-destroy', app);
  })
  ...
  .then(function() {
    ...
    return app.events.emit('post-app-destroy', app);
  })
  // Return.
  .nodeify(callback);
...
exports.rebuild = function(app, callback) {
  ...
  // Uninstall app.
  .then(function() {
    return app.events.emit('pre-app-rebuild', app);
  })
  .then(function() {
    return uninstall(app);
  })
  ...
  // Emit post event.
  .then(function() {
    return app.events.emit('post-app-rebuild', app);
  })
  // Install app.
  .then(function() {
    return start(app);
