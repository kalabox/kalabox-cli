...
exports.activate = function(app, callback) {
  return app.events.emit('pre-activate', app)
  .then(function() {
  ...
  .then(function() {
    return app.events.emit('post-activate', app);
  })
  .nodeify(callback);
};
...
var uninstall = exports.uninstall = function(app, callback) {
  ...
  // Emit pre event.
  .then(function() {
    return app.events.emit('pre-uninstall', app);
  })
  // Kill components.
  .then(function() {
  ...
  // Emit post event.
  .then(function() {
    return app.events.emit('post-uninstall', app);
  })
  // Return.
  .nodeify(callback);
...
var start = exports.start = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-start', app);
  })
  ...
  .then(function() {
    ...
    return app.events.emit('post-start', app);
  })
  // Return.
  .nodeify(callback);
...
var stop = exports.stop = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-stop', app);
  })
  // Stop components.
  .then(function() {
  ...
  .then(function() {
    ...
    return app.events.emit('post-stop', app);
  })
  // Return.
  .nodeify(callback);
...
exports.destroy = function(app, callback) {
  ...
  .then(function() {
    ...
    return app.events.emit('pre-destroy', app);
  })
  ...
  .then(function() {
    ...
    return app.events.emit('post-destroy', app);
  })
  // Return.
  .nodeify(callback);
...
exports.rebuild = function(app, callback) {
  ...
  // Uninstall app.
  .then(function() {
    return app.events.emit('pre-rebuild', app);
  })
  .then(function() {
    return uninstall(app);
  })
  ...
  // Emit post event.
  .then(function() {
    return app.events.emit('post-rebuild', app);
  })
  // Install app.
  .then(function() {
    return start(app);
